...
describe('Course Minimizer Tests', () => {
    it('should minimize courses for a simple major with one track and straightforward requirements', async () => {
        // Mock data
        ...
        const minimizer = new CourseMinimizer([major], completed, courseRepository);
    ...
    it("should minimize courses for a major with a single course requirement", async () => {
        // Mock data
    ...
    it("should minimize courses for a major with an OR requirement", async () => {
        // Mock data
        const courseRepository = new MockCourseRepository();
        const courseA = new Course('CS101', [], 3);
        const courseB = new Course('CS102', [], 3);
    ...
    it("should minimize courses for a major with a track that has multiple requirements", async () => {
        // Mock data
        const courseRepository = new MockCourseRepository();
        const courseA = new Course('CS101', [], 3);
        const courseB = new Course('CS102', [], 3);
    ...
    it("should minimize courses for a major with both tracks and standalone requirements", async () => {
        // Mock data
        const courseRepository = new MockCourseRepository();
        const courseA = new Course('CS101', [], 3);
        const courseB = new Course('CS102', [], 3);
    ...
    it("should minimize courses correctly when some courses are already completed", async () => {
        // Mock data
        const courseRepository = new MockCourseRepository();
        const courseA = new Course('CS101', [], 3);
        const courseB = new Course('CS102', [], 3);
